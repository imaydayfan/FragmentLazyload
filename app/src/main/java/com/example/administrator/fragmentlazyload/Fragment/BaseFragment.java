...
import com.example.administrator.fragmentlazyload.MainActivity;
import com.example.administrator.fragmentlazyload.R;
...
public abstract class BaseFragment extends Fragment {
    ...
    @Override
    public void onViewCreated(View view, @Nullable Bundle saveInstenceState){
        super.onViewCreated(view,saveInstenceState);
        isViewCreated = true;
        lazyLoad();
    }
